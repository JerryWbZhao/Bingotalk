...
#    print mail_body
    ...
    #发送邮箱用户名/密码
    user = 'zhaoweibo@bingotalk.cn'
    password='Xxjqxz69'
    #发送邮箱
    sender='zhaoweibo@bingotalk.cn'
    #多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver=['zhaoweibo@bingotalk.cn','zhaoweibo@scmagic.cn']
    #发送邮件主题
    subject = '自动定时发送测试报告'
...
#要在163有限设置授权码（即客户端的密码），否则会报535
    msg['From'] = 'zhaoweibo@bingotalk.com <zhaoweibo@bingotalk.com>'
