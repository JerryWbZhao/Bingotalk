...
class Teacher(unittest.TestCase):
    ...
    def test_teacher_login(self):
        ...
        try:
        #是一个无法找到的元素id
            driver.find_element_by_xpath("//*[@id='app']/div/div[1]/form/div/div[1]/div/div/div/input").send_keys("zhaoweibo@bingotalk.com")
        except:
...
if __name__ == "__main__":
    ...
    suite.addTest(Teacher("test_teacher_login"))
